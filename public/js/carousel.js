...
var Imagebar = /*#__PURE__*/function (_HTMLElement) {
  _inherits(Imagebar, _HTMLElement);

  var _super = _createSuper(Imagebar);
  ...
  _createClass(Imagebar, [{
    ...
    value: function connectedCallback() {
      ...
      console.log('imagebar connected'); // this.addEventListener('mouseover', e=>{
    ...
    value: function render() {
      ...
      this.shadow.innerHTML = "\n            ".concat(this.styledTemplate, "\n            <img alt='").concat(this.text, "' src=").concat(this.src, ">\n            <es-p class=\"tooltiptext\">").concat(this.text, "</es-p>\n            <es-p class=\"descriptiontext\">\n            ").concat(this.description, "\n            </es-p>\n            ");
    }
  }, {
    key: "src",
    get: function get() {
...
var Toolbar = /*#__PURE__*/function (_HTMLElement) {
...
var AnchorButton = /*#__PURE__*/function (_HTMLElement) {
  _inherits(AnchorButton, _HTMLElement);
  ...
  _createClass(AnchorButton, [{
    ...
    value: function connectedCallback() {
      ...
      this.addEventListener('click', function (e) {
        ...
        console.log("STORYBACKFACE: " + _typeof(storyBackface));
...
var CloseButton = /*#__PURE__*/function (_HTMLElement) {
  _inherits(CloseButton, _HTMLElement);
...
var MenuButton = /*#__PURE__*/function (_HTMLElement) {
  _inherits(MenuButton, _HTMLElement);
...
var Navbutton = /*#__PURE__*/function (_HTMLElement) {
  _inherits(Navbutton, _HTMLElement);
  ...
  _createClass(Navbutton, [{
    ...
    value: function connectedCallback() {
      ...
      this.addEventListener('click', function (e) {
        if (_this2.hasAttribute('active')) {
          return;
        }

        if (_this2.hasAttribute('inactive')) {
          ...
          _this2.removeAttribute('inactive');

          _this2.setAttribute('active', '');

          if (window.outerWidth > 850) {
            var businesscard = document.querySelector('es-carousel').shadowRoot.querySelector("es-businesscard");
            businesscard.setAttribute('text', _this2.text);
          }
        }
        ...
        if (window.outerWidth < 850) {
          ...
          if (_this2.text === 'Contact Us') {
            carousel.setAttribute('mobibusinesscard', 'Contact Us');
          }

          if (_this2.text === 'Portfolio') {
    ...
    key: "render",
    value: function render() {
      this.shadow.innerHTML = "\n        ".concat(this.styleTemplate, "\n        <button>").concat(this.text, "</button>");
    }
  }], [{
    key: "properties",
    get: function get() {
...
var NextButton = /*#__PURE__*/function (_HTMLElement) {
  _inherits(NextButton, _HTMLElement);

  var _super = _createSuper(NextButton);
  ...
  _createClass(NextButton, [{
    ...
    value: function connectedCallback() {
      ...
      window.addEventListener('resize', function (e) {
        _this2.setAttribute('move', '');

        if (document.querySelector('html').getAttribute('mobi') === 'true') {
          _this2.setAttribute('hide', '');
        } else {
          if (_this2.hasAttribute('hide')) {
            _this2.removeAttribute('hide');
          }
        }
      });
      this.addEventListener('click', function (e) {
    ...
    value: function move() {
      ...
      var textBoardSpace = 0.2 * fullWidth; // if (fullWidth <= 850){
...
//import btnGradient from '../../assets/svg/buttonGradient.gif'
var PreviousButton = /*#__PURE__*/function (_HTMLElement) {
  _inherits(PreviousButton, _HTMLElement);

  var _super = _createSuper(PreviousButton);
...
var P1 = /*#__PURE__*/function (_HTMLElement) {
  _inherits(P1, _HTMLElement);

  var _super = _createSuper(P1);
...
/* harmony import */ var _img_Asset4_png__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../img/Asset4.png */ "./resources/img/Asset4.png");
/* harmony import */ var _img_Asset2_png__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../img/Asset2.png */ "./resources/img/Asset2.png");
/* harmony import */ var _img_espiiforweb_png__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../img/espiiforweb.png */ "./resources/img/espiiforweb.png");
/* harmony import */ var _img_jasenalogo_png__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../img/jasenalogo.png */ "./resources/img/jasenalogo.png");
/* harmony import */ var _img_Asset5_png__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../img/Asset5.png */ "./resources/img/Asset5.png");
/* harmony import */ var _img_Asset6_png__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../img/Asset6.png */ "./resources/img/Asset6.png");
/* harmony import */ var _img_phone_png__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../img/phone.png */ "./resources/img/phone.png");
...
var Story = /*#__PURE__*/function (_HTMLElement) {
  _inherits(Story, _HTMLElement);
  ...
  _createClass(Story, [{
    ...
    set: function set(val) {
      for (var i = 0; i < val.length; i++) {
        //console.log(i)
        var img = document.createElement('es-imagebar');
    ...
    value: function setup() {
      ...
      var storyOffset = this.offsetLeft; // if (fullWidth <= 850) {
    ...
    value: function moveMe(val) {
      switch (val) {
        case 'right':
          ...
          storyInacitve.forEach(function (element) {
    ...
    value: function xpand() {
      ...
      if (fullWidth <= 850) {
        ...
        var storyOffset = this.offsetLeft; //var expandLeft = Math.round(-storyOffset + textBoardSpace)
    ...
    key: "cloze",
    value: function cloze() {
      var fullWidth = window.outerWidth * 0.95;
      var textBoardSpace = Math.round(0.2 * fullWidth);
      var storyOffset = this.offsetLeft;
      var storyWidth = 300; // if (fullWidth <= 850) {
      //     var storySpace = Math.round(fullWidth)
      // }
      // else {
      //     var storySpace = Math.round(fullWidth + textBoardSpace)
    ...
    value: function connectedCallback() {
      ...
      console.log('story connected: ' + this.classList); // Handle the start of gestures
      ...
      this.addEventListener('touchstart', function (e) {
        ...
        if (_this2.hasAttribute('expandstory')) {
          return;
        } else {
          var touches = e.changedTouches;
          _this2.firstTouch = touches[0].screenX;
      ...
      this.addEventListener('touchend', function (e) {
        ...
        if (_this2.hasAttribute('expandstory')) {
          ...
          var touches = e.changedTouches;
          _this2.lastTouch = touches[touches.length - 1].screenX;
          var firstTouch = _this2.firstTouch;
          var lastTouch = touches[touches.length - 1].screenX;

          if (firstTouch > lastTouch && _this2.touchMove === 'true') {
    ...
    value: function render() {
      if (this.backface) {
        ...
        this.shadow.innerHTML = "\n            ".concat(this.styleTemplate, "\n            <div>\n                <es-closebutton></es-closebutton>\n                <es-heading text=").concat(this.h1, " textafter=").concat(this.h2, "></es-heading>\n            </div>\n            <es-storybackface ></es-storybackface>\n            ");

        if (this.classList.contains('0')) {
          this.imgset = [[_img_Asset4_png__WEBPACK_IMPORTED_MODULE_1__.default, 'Coart of Arms', 'We design family, company, organizational or state escutcheons with personalized mottos. '], [_img_Asset2_png__WEBPACK_IMPORTED_MODULE_2__.default, 'Escutcheons', 'Rolls of arms are the primary sentiment for brand recognition. Shields have been used across time by noble families and organizations to inform the public about genealogy.'], [_img_espiiforweb_png__WEBPACK_IMPORTED_MODULE_3__.default, 'Corporate Logos', 'Make creative graphic symbols to aid and promote brand recognition across different platforms.'], [_img_jasenalogo_png__WEBPACK_IMPORTED_MODULE_4__.default, 'Production Logos', 'Get digitized logos that can be animated and be used accross multiple digital platforms.']];
        }

        if (this.classList.contains('1')) {
          this.imgset = [[_img_Asset5_png__WEBPACK_IMPORTED_MODULE_5__.default, 'Social Media Design'], [_img_Asset6_png__WEBPACK_IMPORTED_MODULE_6__.default, 'App Design'], [_img_phone_png__WEBPACK_IMPORTED_MODULE_7__.default, 'App Design']];
        }
      } else {
        console.log('story render');
        this.shadow.innerHTML = "\n        ".concat(this.styleTemplate, "\n        <es-image alt=\"").concat(this.h1 + this.h2, "\" img = ").concat(this.img, "></es-image>\n        <es-heading text=").concat(this.h1, " textafter=").concat(this.h2, "></es-heading>\n        <es-p text='").concat(this.ptext, "'></es-p>\n        <es-button></es-button>");
      }
    }
  }, {
    key: "disconnectedCallback",
    ...
    key: "observedAttributes",
    get: function get() {
      return ['active', 'move', 'cssmove', 'expandstory', 'close', 'resize', 'expandleft', 'imgset', 'ptext'];
    }
  }]);
...
var StoryBackface = /*#__PURE__*/function (_HTMLElement) {
  _inherits(StoryBackface, _HTMLElement);

  var _super = _createSuper(StoryBackface);

  function StoryBackface() {
    var _this;

    _classCallCheck(this, StoryBackface);
...
//images
var StoryImages = /*#__PURE__*/function (_HTMLElement) {
  _inherits(StoryImages, _HTMLElement);

  var _super = _createSuper(StoryImages);

  function StoryImages() {
    var _this;

    _classCallCheck(this, StoryImages);
  ...
  _createClass(StoryImages, [{
    ...
    key: "render",
    value: function render() {
      return this.shadow.innerHTML = "\n        ".concat(this.styleTemplate, "\n        <img alt=\"").concat(this.alt, " \"src=").concat(this.img, ">");
    }
  }], [{
    key: "observeredAttributes",
    get: function get() {
      return ['img', 'width'];
    }
  }]);
...
var Label = /*#__PURE__*/function (_HTMLElement) {
  ...
  _createClass(Label, [{
    ...
    key: "render",
    value: function render() {
      this.shadow.innerHTML = "\n        ".concat(this.stylesTemplate, "\n        <text>").concat(this.text, "</text>");
    }
  }], [{
    key: "properties",
    get: function get() {
...
var Businesscard = /*#__PURE__*/function (_HTMLElement) {
  _inherits(Businesscard, _HTMLElement);

  var _super = _createSuper(Businesscard);
...
var H1 = /*#__PURE__*/function (_HTMLElement) {
  _inherits(H1, _HTMLElement);
...
var H2 = /*#__PURE__*/function (_HTMLElement) {
  _inherits(H2, _HTMLElement);
...
var Scrollpad = /*#__PURE__*/function (_HTMLElement) {
  _inherits(Scrollpad, _HTMLElement);

  var _super = _createSuper(Scrollpad);
...
var Textboard = /*#__PURE__*/function (_HTMLElement) {
  _inherits(Textboard, _HTMLElement);

  var _super = _createSuper(Textboard);

  function Textboard() {
    var _this;

    _classCallCheck(this, Textboard);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("/images/Asset2.png?8159792d6398e01019d333b7bd6aa58b");

/***/ }),

/***/ "./resources/img/Asset4.png":
/*!**********************************!*\
  !*** ./resources/img/Asset4.png ***!
  \**********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("/images/Asset4.png?181f06ec6fcc736e50668582ba2c2273");

/***/ }),

/***/ "./resources/img/Asset5.png":
/*!**********************************!*\
  !*** ./resources/img/Asset5.png ***!
  \**********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("/images/Asset5.png?7c82503d53111b1134abdec76ae2607c");

/***/ }),

/***/ "./resources/img/Asset6.png":
/*!**********************************!*\
  !*** ./resources/img/Asset6.png ***!
  \**********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("/images/Asset6.png?49fc4566cd349907bf9a9887a0dd9fc0");

/***/ }),

/***/ "./resources/img/espiiforweb.png":
/*!***************************************!*\
  !*** ./resources/img/espiiforweb.png ***!
  \***************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("/images/espiiforweb.png?417179598bd3cd17818c6658d484826e");

/***/ }),

/***/ "./resources/img/jasenalogo.png":
/*!**************************************!*\
  !*** ./resources/img/jasenalogo.png ***!
  \**************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("/images/jasenalogo.png?df088bba71c30337e8d00ab4f8a482d3");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("/images/phone.png?1ad2771c60fa4e875bdada0f79135f47");
...
/******/ 	__webpack_require__.O(undefined, ["css/fonts","css/style"], () => (__webpack_require__("./resources/js/components/carousel/carousel.js")))
/******/ 	__webpack_require__.O(undefined, ["css/fonts","css/style"], () => (__webpack_require__("./resources/js/components/bars/imagebar/imagebar.js")))
/******/ 	__webpack_require__.O(undefined, ["css/fonts","css/style"], () => (__webpack_require__("./resources/js/components/bars/navbar/navbar.js")))
/******/ 	__webpack_require__.O(undefined, ["css/fonts","css/style"], () => (__webpack_require__("./resources/js/components/bars/searchbar/searchbar.js")))
/******/ 	__webpack_require__.O(undefined, ["css/fonts","css/style"], () => (__webpack_require__("./resources/js/components/bars/sidebar/sidebar.js")))
/******/ 	__webpack_require__.O(undefined, ["css/fonts","css/style"], () => (__webpack_require__("./resources/js/components/bars/toolbar/toolbar.js")))
/******/ 	__webpack_require__.O(undefined, ["css/fonts","css/style"], () => (__webpack_require__("./resources/js/components/buttons/anchorButton.js")))
/******/ 	__webpack_require__.O(undefined, ["css/fonts","css/style"], () => (__webpack_require__("./resources/js/components/buttons/closeButton.js")))
/******/ 	__webpack_require__.O(undefined, ["css/fonts","css/style"], () => (__webpack_require__("./resources/js/components/buttons/menuButton.js")))
/******/ 	__webpack_require__.O(undefined, ["css/fonts","css/style"], () => (__webpack_require__("./resources/js/components/buttons/navButton.js")))
/******/ 	__webpack_require__.O(undefined, ["css/fonts","css/style"], () => (__webpack_require__("./resources/js/components/buttons/nextButton.js")))
/******/ 	__webpack_require__.O(undefined, ["css/fonts","css/style"], () => (__webpack_require__("./resources/js/components/buttons/previousButton.js")))
/******/ 	__webpack_require__.O(undefined, ["css/fonts","css/style"], () => (__webpack_require__("./resources/js/components/logo/logo.js")))
/******/ 	__webpack_require__.O(undefined, ["css/fonts","css/style"], () => (__webpack_require__("./resources/js/components/paragraph/p1.js")))
/******/ 	__webpack_require__.O(undefined, ["css/fonts","css/style"], () => (__webpack_require__("./resources/js/components/storyBoard/story.js")))
/******/ 	__webpack_require__.O(undefined, ["css/fonts","css/style"], () => (__webpack_require__("./resources/js/components/storyBoard/storyBackface.js")))
/******/ 	__webpack_require__.O(undefined, ["css/fonts","css/style"], () => (__webpack_require__("./resources/js/components/storyBoard/storyImage.js")))
/******/ 	__webpack_require__.O(undefined, ["css/fonts","css/style"], () => (__webpack_require__("./resources/js/components/typography/bodyfont/label.js")))
/******/ 	__webpack_require__.O(undefined, ["css/fonts","css/style"], () => (__webpack_require__("./resources/js/components/typography/businessCard/businessCard.js")))
/******/ 	__webpack_require__.O(undefined, ["css/fonts","css/style"], () => (__webpack_require__("./resources/js/components/typography/h1/h1.js")))
/******/ 	__webpack_require__.O(undefined, ["css/fonts","css/style"], () => (__webpack_require__("./resources/js/components/typography/h2/h2.js")))
/******/ 	__webpack_require__.O(undefined, ["css/fonts","css/style"], () => (__webpack_require__("./resources/js/components/typography/scrollPad/scrollPad.js")))
/******/ 	__webpack_require__.O(undefined, ["css/fonts","css/style"], () => (__webpack_require__("./resources/js/components/typography/textBoard/textBoard.js")))
/******/ 	__webpack_require__.O(undefined, ["css/fonts","css/style"], () => (__webpack_require__("./resources/scss/style.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/fonts","css/style"], () => (__webpack_require__("./resources/scss/fonts.scss")))
